...
\begin{frame}{La vision cognitive de l'information}
  ...
  \centerline{
    \begin{tikzpicture}
      ...
      \node [cloudy] (a) at (0,2) {Information};
      \node [cloudy] (b) at (6,2) {Information}
...
\begin{frame}{L'information discrétisée}{Échantillonnage temporel}
  ...
  \end{tikzpicture}
  \begin{itemize}
  \item[\ddialogsystem] Un signal périodique qui peut être décomposé avec une
    fréquence maximale a une borne pour sa reconstruction mathématique exacte
    \emph{(Théorème d'échantillonnage de Nyquist-Shannon)}:
    $$f_e\geqslant 2 f_{\mathrm{Max}}$$
  \item[\dialoginformation] Un peu plus sur ce sujet dans le chapitre sur les signaux
  \end{itemize}
\end{frame}
\begin{frame}{L'information quantifiée}
