			...
			\synt{head}{< -int >}{fichier}
			
			% Description de la commande
			\desc{\begin{itemize}
					\item Affiche par défaut les 10 premières lignes d'un fichier.
					\item Si un entier \lin{n} précède le nom du fichier, la commande affiche les n premières lignes du fichier.
				\end{itemize}
				}
