      ...
      \mprompt{
        ...
        \prompt{ls -l}{%
          \begin{tabular}{@{ }r@{ }r@{ }r@{ }r@{ }r@{ }r@{ }r@{ }r@{ }r}
            ...
            {\color{solarizedGreen}drwxr-xr-x}&2&{\color{solarizedRed}santini}&{\color{blue}ensinfo}&4096&20&jui&15:50&public\_html\\
            {\color{solarizedGreen}-rw-r--r--}&1&{\color{solarizedRed}santini}&{\color{blue}ensinfo}&25&20&jui&15:49&telluriques.txt
          \end{tabular}
        }
      }
    \end{column}
